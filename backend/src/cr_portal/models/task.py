...
class BitrixTask(Base):
    ...
    creator_bitrix_id: Mapped[int | None] = mapped_column(Integer, nullable=True, index=True)
    ...
    task_1c_type_missing: Mapped[bool] = mapped_column(Boolean, default=False, index=True)
