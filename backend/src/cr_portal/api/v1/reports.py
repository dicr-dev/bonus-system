...
async def dashboard(session:AsyncSession=Depends(db_session)):
    ...
    return DashboardSummary(active_deals=t[0],monthly_amount=Decimal(t[1] or 0),machines_count=int(t[2] or 0),integration_1c_deals=t[3],funnels=funnels,responsibles=resp)
